const projects = [
  {
    name: 'Bodega Swap',
    description: `Bodega Swap is an app where users can trade their unwanted items for other users' items. It was built using React, Tailwind CSS, and Supabase, and deployed with Heroku. Bodega Swap is a PWA and is designed responsively to work on any screen size. Built as a final project for Fullstack Academy`,
